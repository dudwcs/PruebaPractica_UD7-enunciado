...
class NotaController
{
    ...
    private const TITULO_NOTA_PERMITIDO = "5- Sustituye en NotaController.php la constante TITULO_NOTA_PERMITIDO por la cadena de texto personalizada que te proporcionó la docente.";
